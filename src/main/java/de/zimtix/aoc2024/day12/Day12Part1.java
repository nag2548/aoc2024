...
public class Day12Part1 extends Day12 {
    private final List<Day12Direction> directions = Day12Direction.getDirections();
    private Day12Field[][] plots;
    ...
    private Pair<List<Day12Field>, Integer> collectAdjacentPlots(Day12Field start) {
